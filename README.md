...
- Print a unicode character (e.g. 65 = A): http://localhost:9080/badapp/Unicode?unicode=65
- Print all unicode characters (0 - 126): http://localhost:9080/badapp/Unicode?unicode=all
- Generate a NullPointerException: http://localhost:9080/badapp/Trouble?exception=1
- Generate an ArithmeticException: http://localhost:9080/badapp/Trouble?exception=2
- Generate an ArrayIndexOutOfBoundsException: http://localhost:9080/badapp/Trouble?exception=3
